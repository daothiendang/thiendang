...
function get_movies_by_tag($tagId, $limit = '') {
    ...
    $sql = 'SELECT wp_posts.ID, wp_posts.post_title, wp_posts.guid FROM wp_posts 
            ...
            ORDER BY CAST(SUBSTRING(SUBSTRING_INDEX(wp_posts.post_title, " ", 1), 4) AS DECIMAL)' . $limitCondition;
...
add_action('wp_ajax_nopriv_create_questions', 'create_questions');